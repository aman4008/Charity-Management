...
{
	$payment_detail = serialize(array($_POST['payment_detail'],$_POST['cardnumber'],$_POST['month'],$_POST['cvv']));
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group">
			<b>Donation Amount: </b>
			<input class="input" name="donationamount" id="donationamount" type="number" placeholder="Donation Amount" class="form-control">
			<span id="err_donationamount" class="errorclass"></span>
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			<b>Donor Name: </b>
			<input class="input" name="donorname" id="donorname" type="text" placeholder="Donor Name" class="form-control" value="<?php echo $rsdonor['name']; ?>">
			<span id="err_donorname" class="errorclass"></span>
		</div>
	</div>
</div><hr>
<div class="row">
...
<div class="col-md-6">
	<div class="form-group">
		<b>Card holder: </b>
		<input class="input" type="text" name="cardholder" placeholder="Card holder" class="form-control">
		<span id="err_cardholder" class="errorclass"></span>
	</div>
</div>
<div class="col-md-6">
	<div class="form-group">
		<b>Card Number: </b>
		<input name="cardnumber" class="input" type="text" placeholder="Card Number" type="email" class="form-control">
		<span id="err_cardnumber" class="errorclass"></span>
	</div>
</div> 
<div class="col-md-6">
	<div class="form-group">
		<b>Expiry date: </b>
		<input class="input" type="month" name="month" placeholder="Expiry date" class="form-control">
		<span id="err_month" class="errorclass"></span>
	</div>
</div>
<div class="col-md-6">
	<div class="form-group">
		<b>CVV Number: </b>
		<input class="input" placeholder="CVV Number" name="cvv" type="text" class="form-control">
		<span id="err_cvv" class="errorclass"></span>
	</div>
</div>
</div>		
...
{
	document.getElementById("err_donationamount").innerHTML = "Kindly enter donation amount ..";
	i=1;
}
if(document.getElementById("donorname").value == "")
{
	document.getElementById("err_donorname").innerHTML = "Kindly enter donar name...";
	i=1;
}
if(document.getElementById("cardholder").value == "")
{
	document.getElementById("err_cardholder").innerHTML = "Kindly enter card holder name..";
	i=1;
}
if(document.getElementById("cardnumber").value == "")
{
	document.getElementById("err_cardnumber").innerHTML = "Kindly enter card number";
	i=1;
}
if(document.getElementById("month").value == "")
{
	document.getElementById("err_month").innerHTML = "Kindly enter expiry month..";
	i=1;
}
if(document.getElementById("cvv").value == "")
{
	document.getElementById("err_cvv").innerHTML = "Kindly enter cvv..";
	i=1;
}
if(i == 0)
	{
