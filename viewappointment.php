...
<div id="about" class="section">
	<div class="container">
		<div class="row">
			...
			<h2 class="title">view appointment</h2>
			</div>
			</div>
		</div>
	</div>
...
<?php
	...
	while($rs = mysqli_fetch_array($qsql))
	{
		echo "<tr>
			...
			<td style='text-align: left;'><b>Date:</b> " . date("d-M-Y",strtotime($rs['appointment_date'])) . "<br> <b>Time:</b> " . date("h:i A",strtotime($rs['appointment_date'])) . "</td>
			<td>$rs[status]";		
		echo "</td>
			<td>";
