...
<div class="media-body">
	...
	<p>
<form method="post" action="photo.php" enctype="multipart/form-data" onsubmit="return validateform()">
...
<div class="row">
	...
	<div class="col-md-10">
		<input type="file" name="fileUpload[]" id="photo" multiple="multiple" class="form-control" accept="image/*" >
		<?php
		if(isset($_GET['editid']))
		{
